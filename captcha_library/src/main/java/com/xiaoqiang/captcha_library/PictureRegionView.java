...
class PictureRegionView extends AppCompatImageView {
    ...
    public PictureRegionView (Context context) {
        this(context, null);
    }

    public PictureRegionView (Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public PictureRegionView (Context context, AttributeSet attrs, int defStyleAttr) {
