...
public class Captcha extends LinearLayout {
    ...
    //控件成员
    private PictureRegionView vertifyView;         //拼图块
    ...
    public Captcha(@NonNull final Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        drawableId = typedArray.getResourceId(R.styleable.Captcha_src, R.drawable.childhood_picture);
    ...
    private void init() {
        ...
        vertifyView = (PictureRegionView) parentView.findViewById(R.id.vertifyView);
        ...
        vertifyView.callback(new PictureRegionView.Callback() {
            @Override
