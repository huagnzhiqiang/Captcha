...
import com.xiaoqiang.captcha_library.Captcha;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void changePicture(View view){
        if(isCat){
            captcha.setBitmap("https://resources.ninghao.org/images/candy-shop.jpg");
        }else{
            captcha.setBitmap(R.mipmap.gravity_falls);
        }
        isCat=!isCat;
    }
